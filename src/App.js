import { Button, Divider, Drawer, Row, Spin } from 'antd';
      ...
      >
        <div className="container">
          ...
          <div style={{ textAlign: 'justify' }} className="mt-2">
            ...
            die Daten für Frankfurt (6412) und Duisburg (5112) geladen. Beachten Sie die Trennung
            der Gemeindeschlüssel mit einem Komma!
          </div>
        </div>
      </Drawer>
    </div>
